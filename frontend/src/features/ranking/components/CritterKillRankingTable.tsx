...
import type { CritterKillRankPlayer } from '../types';

const columns: ColumnDef<CritterKillRankPlayer>[] = [
  {
    accessorKey: 'name',
    header: '角色名',
    cell: ({ row }) => (
  ...
  { accessorKey: 'critter_kill_count', header: '杀死小动物数' },
];

interface CritterKillRankingTableProps {
  data: CritterKillRankPlayer[];
}

export function CritterKillRankingTable({ data }: CritterKillRankingTableProps) {
