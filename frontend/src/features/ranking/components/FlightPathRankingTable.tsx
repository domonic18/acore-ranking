...
import type { FlightPathRankPlayer } from '../types';

const columns: ColumnDef<FlightPathRankPlayer>[] = [
  {
    accessorKey: 'name',
    header: '角色名',
    cell: ({ row }) => (
  ...
  { accessorKey: 'flight_path_count', header: '乘坐飞行点次数' },
];

interface FlightPathRankingTableProps {
  data: FlightPathRankPlayer[];
}

export function FlightPathRankingTable({ data }: FlightPathRankingTableProps) {
