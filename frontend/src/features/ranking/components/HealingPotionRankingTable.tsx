...
import type { HealingPotionRankPlayer } from '../types';

const columns: ColumnDef<HealingPotionRankPlayer>[] = [
  {
    accessorKey: 'name',
    header: '角色名',
    cell: ({ row }) => (
  ...
  { accessorKey: 'healing_potion_count', header: '饮用治疗药水数' },
];

interface HealingPotionRankingTableProps {
  data: HealingPotionRankPlayer[];
}

export function HealingPotionRankingTable({ data }: HealingPotionRankingTableProps) {
