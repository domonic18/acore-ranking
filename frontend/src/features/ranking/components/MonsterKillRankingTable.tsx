...
import type { MonsterKillRankPlayer } from '../types';

const columns: ColumnDef<MonsterKillRankPlayer>[] = [
  {
    accessorKey: 'name',
    header: '角色名',
    cell: ({ row }) => (
  ...
  { accessorKey: 'monster_kill_count', header: '杀死怪物数' },
];

interface MonsterKillRankingTableProps {
  data: MonsterKillRankPlayer[];
}

export function MonsterKillRankingTable({ data }: MonsterKillRankingTableProps) {
