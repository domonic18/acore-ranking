...
import type { Raid10RankPlayer } from '../types';

const columns: ColumnDef<Raid10RankPlayer>[] = [
  {
    accessorKey: 'name',
    header: '角色名',
    cell: ({ row }) => (
  ...
  { accessorKey: 'raid_10_count', header: '10人团本次数' },
];

interface Raid10RankingTableProps {
  data: Raid10RankPlayer[];
}

export function Raid10RankingTable({ data }: Raid10RankingTableProps) {
