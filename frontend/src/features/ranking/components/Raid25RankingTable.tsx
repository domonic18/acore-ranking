...
import type { Raid25RankPlayer } from '../types';

const columns: ColumnDef<Raid25RankPlayer>[] = [
  {
    accessorKey: 'name',
    header: '角色名',
    cell: ({ row }) => (
  ...
  { accessorKey: 'raid_25_count', header: '25人团本次数' },
];

interface Raid25RankingTableProps {
  data: Raid25RankPlayer[];
}

export function Raid25RankingTable({ data }: Raid25RankingTableProps) {
