...
import type { TodayKillsRankPlayer } from '../types';

const columns: ColumnDef<TodayKillsRankPlayer>[] = [
  {
    accessorKey: 'name',
    header: '角色名',
    cell: ({ row }) => (
  ...
  { accessorKey: 'today_kills', header: '今日击杀' },
];

interface TodayKillsRankingTableProps {
  data: TodayKillsRankPlayer[];
}

export function TodayKillsRankingTable({ data }: TodayKillsRankingTableProps) {
